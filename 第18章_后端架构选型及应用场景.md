...
<img src="content/ch18-2.png" alt="ch1" style="zoom: 50%;" />
...
![Deeplearning4j](img/ch19/18-2-2.png)
...
![Mahout](img/ch19/18-2-3-1.png)

&emsp;&emsp;Mahout应用场景：

![Mahout](img/ch19/18-2-3-2.png)
...
![架构图](img/ch19/18-2-5-1.png)
<center>架构图</center>

![任务调度图](img/ch19/18-2-5-2.png)
<center>任务调度图</center>
...
![Spark Streaming架构图](img/ch19/18-2-6-1.png)
...
![Spark Streaming基本原理图](img/ch19/18-2-6-2.png)
...
![架构图](img/ch19/18-2-10-1.png)

![运行流程图](img/ch19/18-2-10-2.png)
...
![](img/ch19/18-5-4-1.jpg)

- **通用纠错模型：神经网络模型，其他纠错保底**

![](img/ch19/18-5-4-2.jpg)
...
- 排序算法演进
  ...
  ![](img/ch19/18-6-2-2.jpg)

### 18.6.5 离线训练

- 离线训练流程

  ![](img/ch19/18-6-5-1.jpg)
...
- **采用FTRL(Follow The Regularized Leader)更新模型**
  ...
  - 算法要点与推导 
    ...
    ![](H:/DeepLearning-500-questions/ch18_%E5%90%8E%E7%AB%AF%E6%9E%B6%E6%9E%84%E9%80%89%E5%9E%8B%E5%8F%8A%E5%BA%94%E7%94%A8%E5%9C%BA%E6%99%AF/img/ch19/18-6-2-1-0.png)
  ...
  - 算法特性及优缺点 
    ...
    　　5.使用正负样本的数目来计算梯度的和（所有的model具有同样的N和P）
     ...
     　　   ![](H:/DeepLearning-500-questions/ch18_%E5%90%8E%E7%AB%AF%E6%9E%B6%E6%9E%84%E9%80%89%E5%9E%8B%E5%8F%8A%E5%BA%94%E7%94%A8%E5%9C%BA%E6%99%AF/img/ch19/18-6-2-1-1.jpg)
...
![](img/ch19/18-6-3-1.jpg)

**如果是做搜索，那就是保证召回的情况下提升准确率；如果做疾病监测、反垃圾，则是保准确率的条件下，提升召回。**

所以，在两者都要求高的情况下，可以用F1值来衡量。

![F-Measure](img/ch19/18-9-2-2.png)
...
![F-Measure](img/ch19/18-9-2-1.png)
...
- **AP和mAP(mean Average Precision)** 
  ...
  ![](img/ch19/18-6-3-3.jpg)

- **ROC和AUC** 

  ​	ROC和AUC是评价分类器的指标，上面第一个图的ABCD仍然使用，只是需要稍微变换。 

  ![](img/ch19/18-6-3-4.jpg)
